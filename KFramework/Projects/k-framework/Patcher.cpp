...
kfw::core::PatchInfo::PatchInfo(const DWORD64 address, const char* toWrite, const char* name) {
...
kfw::core::PatchInfo::PatchInfo(const char* module, const char* pattern, const char* mask, const char* toWrite, const char* name) {
...
bool kfw::core::PatchInfo::patchPattern() {
...
bool kfw::core::PatchInfo::patchAddress() {
...
bool kfw::core::PatchInfo::prefetchAddress() {
    this->type = PATCHTYPE_ADDRESS;
    this->address = kfw::core::Utils::findPattern(this->module, this->pattern, this->mask);
    if (this->address == 0)
    {
        return false;
    }
...
bool kfw::core::PatchInfo::unpatch() {
